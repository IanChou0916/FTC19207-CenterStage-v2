...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double ticksPerRev = DriveConstantstEST.TICKS_PER_REV;
        public double maxRpm = DriveConstantstEST.MAX_RPM;
        public boolean runUsingEncoder = DriveConstantstEST.RUN_USING_ENCODER;
        public double motorP = DriveConstantstEST.MOTOR_VELO_PID.p;
        public double motorI = DriveConstantstEST.MOTOR_VELO_PID.i;
        public double motorD = DriveConstantstEST.MOTOR_VELO_PID.d;
        public double motorF = DriveConstantstEST.MOTOR_VELO_PID.f;
        public double wheelRadius = DriveConstantstEST.WHEEL_RADIUS;
        public double gearRatio = DriveConstantstEST.GEAR_RATIO;
        public double trackWidth = DriveConstantstEST.TRACK_WIDTH;
        public double kV = DriveConstantstEST.kV;
        public double kA = DriveConstantstEST.kA;
        public double kStatic = DriveConstantstEST.kStatic;
        public double maxVel = DriveConstantstEST.MAX_VEL;
        public double maxAccel = DriveConstantstEST.MAX_ACCEL;
        public double maxAngVel = DriveConstantstEST.MAX_ANG_VEL;
        public double maxAngAccel = DriveConstantstEST.MAX_ANG_ACCEL;
        ...
        public RevHubOrientationOnRobot.LogoFacingDirection LOGO_FACING_DIR = DriveConstantstEST.LOGO_FACING_DIR;
        public RevHubOrientationOnRobot.UsbFacingDirection USB_FACING_DIR = DriveConstantstEST.USB_FACING_DIR;
